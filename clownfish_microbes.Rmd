...
Assigning taxonomy for amplicon sequence variants using the Silva v138 reference database. All parameters were conserved from the database presets.
```{r}
