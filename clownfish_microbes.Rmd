...
To filter the reads, we set trunclen to 240 because no samples fell below a quality score of 20 after 250 bp. 
...
We used SILVA as our reference database because it was the reference database used in the paper.
