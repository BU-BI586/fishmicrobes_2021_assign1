...
Write cvs file to save the full sequences and sequences with chimeras removed.This table shows raw reads, how many filtered, denoised, etc.The final number of reads under nonchim column. You could include table of this in paper 
```{r}
...
plot_ordination(ps.top90, ord.nmds.bray, color='color', title="Bray NMDS")
